        ...
        start: function(detail){  
          ...
          this.dataDetail = `data-detail='{
                          "click": [
                              {"dest":"ripple" },
                              {"dest":"menu", "act":"hide"}, 
                              { "dest":"goku", "elem":"fullcont", "id":"goku-fullcont", "act":"selectOne",  "entity":"goku", "dbid": ${detail.dbid} }
           ]}'`
        ...
        start: function(detail){  
          ...
          this.dataDetail = `data-detail='{
                          "click": [
                              {"dest":"ripple" },
                              {"dest":"menu", "act":"hide"}, 
                              {"dest":"goku", "elem":"dt", "act":"trPrint", "entity":"goku", "dbid":"${detail.dbid}" } 
        ...
        start: function(detail){  
          ...
          this.dataDetail = `data-detail='{
                            "click": [
                              {"dest":"ripple" },
                              {"dest":"menu", "act":"hide"}, 
                              {"dest":"goku", "elem":"fullcont", "act":"deleteEntity", "entity":"goku", "dbid":["${detail.dbid}"] } 
           ]}'`
      ...
      { text: '', 
        ...
        dataDetail:`data-detail='{
                          "click": [
                              {"dest":"ripple" },
                              {"dest":"menu", "act":"hide"},
                              {"dest":"goku", "elem":"dialog", "id":"hellow", "act":"show"}
        ]}'`,
              ...
              if( ids.length > 0 ){
                  ...
                  this.dataDetail = `data-detail='{
                                    "click": [
                                        {"dest":"ripple" },
                                        {"dest":"menu", "act":"hide"},
                                        {"dest":"goku", "elem":"fullcont", "act":"deleteEntity", "entity":"goku",  "dbid":[${ids}]} ]}'`             
              }else{ 
                   this.class = `disabled`
        ...
        start: function(detail, htmlDt, htmlFc){  
                ...
                this.dataDetail = `data-detail='{
                                   "click": [
                                      {"dest":"ripple" },
                                      {"dest":"menu", "act":"hide"},
                                      {"dest":"goku", "elem":"fullcont",  "id":"goku-fullcont", "act":"prepareEdit" }  ]}'`             
            }/**/
      },
              ...
              //if exist one check
                  ...
                  this.dataDetail = `data-detail='{
                                    "click": [
                                        {"dest":"ripple" },
                                        {"dest":"menu", "act":"hide"},
                                        {"dest":"goku", "elem":"fullcont", "act":"deleteEntity", "entity":"goku",  "dbid":[${dbid}]} ]}'`             
