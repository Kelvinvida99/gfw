const generator = require('./services-fullcont-multitable-generator')
...
export const servicesMT = [

	{
		tableName: "services_vs_powers", 
		value:'', 
		id:'services_form_services_vs_powers',
		html:'',
		data:     [],
		dataCopy: [],
		oneRequired: false,
		fields: [ //the order elements should be the same on the server services.php

			{ name:      'au__services_vs_powers_vs_power', 
			  type:      'autocomplete',
			  html:      '',
			  required:  false,  },	
		...
		generator: function(line){ 
			return generator.services_vs_powers(line.id) 
		},

		add: function(){ 
			const newLine = generator.services_vs_powers('')
			this.html.insertAdjacentHTML("beforeend", newLine) 
		} 
	},
	
	{
		tableName: "services_vs_countries", 
		value:'', 
		id:'services_form_services_vs_countries',
		html:'',
		data:     [],
		dataCopy: [],
		oneRequired: false,
		...
		generator: function(line){ 
			return generator.services_vs_countries(line.id) 
		},

		add: function(){ 
			const newLine = generator.services_vs_countries('')
			this.html.insertAdjacentHTML("beforeend", newLine) 
		} 
	},
