...
const {organizeRow} = require('./services-dt-handler')
const {tableDetail} = require('./services-dt-handler')
...
function HTMLselect(){ 
      ...
      dtHandler.HTMLselect('services-dt', htmlDt, organizeRow, tableDetail)
...
const obj = {
      ...
      tableOptions:   { start: (detail)=>{  servicesMenu.start(detail, htmlDt, 'htmlFc')  }},
      trMenu:         { start: (detail)=>{  servicesMenu.start(detail, htmlDt, 'htmlFc')  }},
