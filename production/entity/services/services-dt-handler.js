...
export const tableDetail = {
    entity: 'services',//name table on the db
    dest: 'services',//name of the entity on the system

    //action for body 
    //left click, directly to the fullcont 
    tdDataDetail:`data-detail='{ "click": [ {"dest":"ripple" },
                                            {"dest":"services", "elem":"fullcont", "id":"services-fullcont", "act":"selectOne", "entity":"services", "dbid": "#dbid"}  ],
                                
                                 "clickRight": [{"dest":"services", "elem":"dt", "act":"trMenu", "id":"trMenu",  "entity":"services", "dbid": "#dbid" } ]  }'`,
