...
export function update(message){  console.log('tvDashboardHome> page', message.message.row[0].dest)

   if(!HTMLwasSelected) { console.log('no tv is init'); return}

   console.log('tv was init > page', message.message.row[0].dest)
