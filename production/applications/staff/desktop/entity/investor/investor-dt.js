...
const {organizeRow} = require('./investor-dt-handler')
const {tableDetail} = require('./investor-dt-handler')
...
function HTMLselect(){ 
      ...
      dtHandler.HTMLselect('investor-dt', htmlDt, organizeRow, tableDetail)
...
const obj = {
      ...
      tableOptions:   { start: (detail)=>{  investorMenu.start(detail, htmlDt, 'htmlFc')  }},
      trMenu:         { start: (detail)=>{  investorMenu.start(detail, htmlDt, 'htmlFc')  }},
