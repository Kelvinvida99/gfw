        ...
        start: function(detail){  
          ...
          this.dataDetail = `data-detail='{
                          "click": [
                              {"dest":"ripple" },
                              {"dest":"menu", "act":"hide"}, 
                              { "dest":"investor", "elem":"fullcont", "id":"investor-fullcont", "act":"selectOne",  "entity":"investor", "dbid": ${detail.dbid} }
           ]}'`
        ...
        start: function(detail){  
          ...
          this.dataDetail = `data-detail='{
                          "click": [
                              {"dest":"ripple" },
                              {"dest":"menu", "act":"hide"}, 
                              {"dest":"investor", "elem":"dt", "act":"trPrint", "entity":"investor", "dbid":"${detail.dbid}" } 
        ...
        start: function(detail){  
          ...
          this.dataDetail = `data-detail='{
                            "click": [
                              {"dest":"ripple" },
                              {"dest":"menu", "act":"hide"}, 
                              {"dest":"investor", "elem":"fullcont", "act":"deleteEntity", "entity":"investor", "dbid":["${detail.dbid}"] } 
           ]}'`
      ...
      { text: '', 
        ...
        dataDetail:`data-detail='{
                          "click": [
                              {"dest":"ripple" },
                              {"dest":"menu", "act":"hide"},
                              {"dest":"investor", "elem":"dialog", "id":"hellow", "act":"show"}
        ]}'`,
              ...
              if( ids.length > 0 ){
                  ...
                  this.dataDetail = `data-detail='{
                                    "click": [
                                        {"dest":"ripple" },
                                        {"dest":"menu", "act":"hide"},
                                        {"dest":"investor", "elem":"fullcont", "act":"deleteEntity", "entity":"investor",  "dbid":[${ids}]} ]}'`             
              }else{ 
                   this.class = `disabled`
        ...
        start: function(detail, htmlDt, htmlFc){  
                ...
                this.dataDetail = `data-detail='{
                                   "click": [
                                      {"dest":"ripple" },
                                      {"dest":"menu", "act":"hide"},
                                      {"dest":"investor", "elem":"fullcont",  "id":"investor-fullcont", "act":"prepareEdit" }  ]}'`             
            }/**/
      },
              ...
              //if exist one check
                  ...
                  this.dataDetail = `data-detail='{
                                     "click": [
                                        {"dest":"ripple" },
                                        {"dest":"menu", "act":"hide"},
                                        {"dest":"investor", "elem":"dt", "act":"trPrint"} ]}'`             
            }/**/
      },
              ...
              //if exist one check
                  ...
                  this.dataDetail = `data-detail='{
                                    "click": [
                                        {"dest":"ripple" },
                                        {"dest":"menu", "act":"hide"},
                                        {"dest":"investor", "elem":"fullcont", "act":"deleteEntity", "entity":"investor",  "dbid":[${dbid}]} ]}'`             
