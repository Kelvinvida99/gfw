...
const snackBody = {
	...
	noDecimal: { 
        ...
        start: function(){  
          this.title   = 'Decimal amounts are not accepted in this field'        //language.start('inProgress')     
      ...
      restriction: { 
        ...
        start: function(){  
          this.title   = 'You cannot delete this item'        //language.start('inProgress')     
          // this.btn     = 'Undo'        //language.start('inProgress')     
  ...
  errorDownDtGoku: { 
        ...
        start: function(addTitle){  
          this.title   = 'Error downloading purchase data from the server'        //language.start('inProgress')     
