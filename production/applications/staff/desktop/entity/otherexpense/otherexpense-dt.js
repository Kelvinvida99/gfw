...
const {organizeRow} = require('./otherexpense-dt-handler')
const {tableDetail} = require('./otherexpense-dt-handler')
...
function HTMLselect(){ 
      ...
      dtHandler.HTMLselect('otherexpense-dt', htmlDt, organizeRow, tableDetail)
...
const obj = {
      ...
      tableOptions:   { start: (detail)=>{  otherexpenseMenu.start(detail, htmlDt, 'htmlFc')  }},
      trMenu:         { start: (detail)=>{  otherexpenseMenu.start(detail, htmlDt, 'htmlFc')  }},
