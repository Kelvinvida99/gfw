        ...
        start: function(detail){  
          ...
          this.dataDetail = `data-detail='{
                          "click": [
                              {"dest":"ripple" },
                              {"dest":"menu", "act":"hide"}, 
                              { "dest":"accounts", "elem":"fullcont", "id":"accounts-fullcont", "act":"selectOne",  "entity":"accounts", "dbid": ${detail.dbid} }
           ]}'`
        ...
        start: function(detail){  
          ...
          this.dataDetail = `data-detail='{
                          "click": [
                              {"dest":"ripple" },
                              {"dest":"menu", "act":"hide"}, 
                              {"dest":"accounts", "elem":"dt", "act":"trPrint", "entity":"accounts", "dbid":"${detail.dbid}" } 
        ...
        start: function(detail){  
          ...
          this.dataDetail = `data-detail='{
                            "click": [
                              {"dest":"ripple" },
                              {"dest":"menu", "act":"hide"}, 
                              {"dest":"accounts", "elem":"fullcont", "act":"deleteEntity", "entity":"accounts", "dbid":["${detail.dbid}"] } 
           ]}'`
      ...
      { text: '', 
        ...
        dataDetail:`data-detail='{
                          "click": [
                              {"dest":"ripple" },
                              {"dest":"menu", "act":"hide"},
                              {"dest":"accounts", "elem":"dialog", "id":"hellow", "act":"show"}
        ]}'`,
              ...
              if( ids.length > 0 ){
                  ...
                  this.dataDetail = `data-detail='{
                                    "click": [
                                        {"dest":"ripple" },
                                        {"dest":"menu", "act":"hide"},
                                        {"dest":"accounts", "elem":"fullcont", "act":"deleteEntity", "entity":"accounts",  "dbid":[${ids}]} ]}'`             
              }else{ 
                   this.class = `disabled`
        ...
        start: function(detail, htmlDt, htmlFc){  
                ...
                this.dataDetail = `data-detail='{
                                   "click": [
                                      {"dest":"ripple" },
                                      {"dest":"menu", "act":"hide"},
                                      {"dest":"accounts", "elem":"fullcont",  "id":"accounts-fullcont", "act":"prepareEdit" }  ]}'`             
            }/**/
      },
              ...
              //if exist one check
                  ...
                  this.dataDetail = `data-detail='{
                                     "click": [
                                        {"dest":"ripple" },
                                        {"dest":"menu", "act":"hide"},
                                        {"dest":"accounts", "elem":"dt", "act":"trPrint"} ]}'`             
            }/**/
      },
              ...
              //if exist one check
                  ...
                  this.dataDetail = `data-detail='{
                                    "click": [
                                        {"dest":"ripple" },
                                        {"dest":"menu", "act":"hide"},
                                        {"dest":"accounts", "elem":"fullcont", "act":"deleteEntity", "entity":"accounts",  "dbid":[${dbid}]} ]}'`             
