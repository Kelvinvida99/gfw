        ...
        start: function(detail){  
          ...
          this.dataDetail = `data-detail='{
                          "click": [
                              {"dest":"ripple" },
                              {"dest":"menu", "act":"hide"}, 
                              { "dest":"shipper", "elem":"fullcont", "id":"shipper-fullcont", "act":"selectOne",  "entity":"shipper", "dbid": ${detail.dbid} }
           ]}'`
        ...
        start: function(detail){  
          ...
          this.dataDetail = `data-detail='{
                          "click": [
                              {"dest":"ripple" },
                              {"dest":"menu", "act":"hide"}, 
                              {"dest":"shipper", "elem":"dt", "act":"trPrint", "entity":"shipper", "dbid":"${detail.dbid}" } 
        ...
        start: function(detail){  
          ...
          this.dataDetail = `data-detail='{
                            "click": [
                              {"dest":"ripple" },
                              {"dest":"menu", "act":"hide"}, 
                              {"dest":"shipper", "elem":"fullcont", "act":"deleteEntity", "entity":"shipper", "dbid":["${detail.dbid}"] } 
           ]}'`
      ...
      { text: '', 
        ...
        dataDetail:`data-detail='{
                          "click": [
                              {"dest":"ripple" },
                              {"dest":"menu", "act":"hide"},
                              {"dest":"shipper", "elem":"dialog", "id":"hellow", "act":"show"}
        ]}'`,
              ...
              if( ids.length > 0 ){
                  ...
                  this.dataDetail = `data-detail='{
                                    "click": [
                                        {"dest":"ripple" },
                                        {"dest":"menu", "act":"hide"},
                                        {"dest":"shipper", "elem":"fullcont", "act":"deleteEntity", "entity":"shipper",  "dbid":[${ids}]} ]}'`             
              }else{ 
                   this.class = `disabled`
        ...
        start: function(detail, htmlDt, htmlFc){  
                ...
                this.dataDetail = `data-detail='{
                                   "click": [
                                      {"dest":"ripple" },
                                      {"dest":"menu", "act":"hide"},
                                      {"dest":"shipper", "elem":"fullcont",  "id":"shipper-fullcont", "act":"prepareEdit" }  ]}'`             
            }/**/
      },
              ...
              //if exist one check
                  ...
                  this.dataDetail = `data-detail='{
                                     "click": [
                                        {"dest":"ripple" },
                                        {"dest":"menu", "act":"hide"},
                                        {"dest":"shipper", "elem":"dt", "act":"trPrint"} ]}'`             
            }/**/
      },
              ...
              //if exist one check
                  ...
                  this.dataDetail = `data-detail='{
                                    "click": [
                                        {"dest":"ripple" },
                                        {"dest":"menu", "act":"hide"},
                                        {"dest":"shipper", "elem":"fullcont", "act":"deleteEntity", "entity":"shipper",  "dbid":[${dbid}]} ]}'`             
