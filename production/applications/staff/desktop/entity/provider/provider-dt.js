...
const {organizeRow} = require('./provider-dt-handler')
const {tableDetail} = require('./provider-dt-handler')
...
function HTMLselect(){ 
      ...
      dtHandler.HTMLselect('provider-dt', htmlDt, organizeRow, tableDetail)
...
const obj = {
      ...
      tableOptions:   { start: (detail)=>{  providerMenu.start(detail, htmlDt, 'htmlFc')  }},
      trMenu:         { start: (detail)=>{  providerMenu.start(detail, htmlDt, 'htmlFc')  }},
