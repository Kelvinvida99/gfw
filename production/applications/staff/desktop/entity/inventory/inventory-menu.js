...
const menuBody = {
  ...
  trMenu: [
        ...
        start: function(detail){  
          ...
          this.dataDetail = `data-detail='{
                          "click": [
                              {"dest":"ripple" },
                              {"dest":"menu", "act":"hide"}, 
                              { "dest":"inventory", "elem":"fullcont", "id":"inventory-fullcont", "act":"selectOne",  "entity":"inventory", "dbid": ${detail.dbid} }
           ]}'`
      ...
      { text: '', 
        ...
        start: function(detail){  
          this.text   = 'Item Report'        //language.start('inProgress')
          this.dataDetail = `data-detail='{
                          "click": [
                              {"dest":"ripple" },
                              {"dest":"menu", "act":"hide"}, 
                              {"dest":"inventory", "elem":"report", "reportType":"reportOne", "entity":"inventory", "dbid":"${detail.dbid}", "source":"dt" } 
        ...
        start: function(detail){  
          ...
          this.dataDetail = `data-detail='{
                            "click": [
                              {"dest":"ripple" },
                              {"dest":"menu", "act":"hide"}, 
                              {"dest":"inventory", "elem":"fullcont", "act":"deleteEntity", "entity":"inventory", "dbid":["${detail.dbid}"] } 
           ]}'`
              ...
              if( ids.length > 0 ){
                  ...
                  this.dataDetail = `data-detail='{
                                    "click": [
                                        {"dest":"ripple" },
                                        {"dest":"menu", "act":"hide"},
                                        {"dest":"inventory", "elem":"fullcont", "act":"deleteEntity", "entity":"inventory",  "dbid":[${ids}]} ]}'`             
              }else{ 
                   this.class = `disabled`
        ...
        start: function(detail, htmlDt, htmlFc){  
                ...
                this.dataDetail = `data-detail='{
                                   "click": [
                                      {"dest":"ripple" },
                                      {"dest":"menu", "act":"hide"},
                                      {"dest":"inventory", "elem":"fullcont",  "id":"inventory-fullcont", "act":"prepareEdit" }  ]}'`             
            }/**/
      },
              ...
              //if exist one check
                  ...
                  this.dataDetail = `data-detail='{
                                     "click": [
                                        {"dest":"ripple" },
                                        {"dest":"menu", "act":"hide"},
                                        {"dest":"inventory", "elem":"dt", "act":"trPrint"} ]}'`             
            }/**/
      },
              ...
              //if exist one check
                  ...
                  this.dataDetail = `data-detail='{
                                    "click": [
                                        {"dest":"ripple" },
                                        {"dest":"menu", "act":"hide"},
                                        {"dest":"inventory", "elem":"fullcont", "act":"deleteEntity", "entity":"inventory",  "dbid":[${dbid}]} ]}'`             
