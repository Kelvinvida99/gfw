	...
	<div class="line line-${id}" lineId="${id}"  > 
	    ...
	    <div class="row">
	      ...
	      <div class="c50">
            ...
            <div class="textfield   textfield-autocomplete au__goku_vs_powers_vs_power" id="customer_form_department_mt_${acUnicId}" selected = '[]'  max = '3'>

                <input autocomplete="off"  class= 'elem' type="text" 
                      data-detail='{
                     "key": [   {"dest":"textfield",    "act":"typing" }, 
                                {"dest":"autocomplete", "act":"typing",  "entity": "powers", "mainFilter": ["name"], "parent": "customer_form_department_mt_${acUnicId}"   }],
                     "click": [ {"dest":"autocomplete", "act":"click",   "entity": "powers", "mainFilter": ["name"], "parent": "customer_form_department_mt_${acUnicId}"   }]
                     }' >
