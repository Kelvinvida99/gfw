...
export function start( detail ){  console.log('dialog employesspayment detail', detail)
...
const dialogBody = {
	...
	hellow: { 
		...
		start: function(){
			this.title     = 'Warning'
			this.des       = 'Allow access at least to one entity for no admin employesspayments.  At the moment all are as "DENY" '
