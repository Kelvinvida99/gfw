...
const {organizeRow} = require('./item_unit-dt-handler')
const {tableDetail} = require('./item_unit-dt-handler')
...
function HTMLselect(){ 
      ...
      dtHandler.HTMLselect('item_unit-dt', htmlDt, organizeRow, tableDetail)
...
const obj = {
      ...
      tableOptions:   { start: (detail)=>{  item_unitMenu.start(detail, htmlDt, 'htmlFc')  }},
      trMenu:         { start: (detail)=>{  item_unitMenu.start(detail, htmlDt, 'htmlFc')  }},
