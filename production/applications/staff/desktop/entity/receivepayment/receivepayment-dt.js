...
const {organizeRow} = require('./receivepayment-dt-handler')
const {tableDetail} = require('./receivepayment-dt-handler')
...
function HTMLselect(){ 
      ...
      dtHandler.HTMLselect('receivepayment-dt', htmlDt, organizeRow, tableDetail)
...
const obj = {
      ...
      tableOptions:   { start: (detail)=>{  receivepaymentMenu.start(detail, htmlDt, 'htmlFc')  }},
      trMenu:         { start: (detail)=>{  receivepaymentMenu.start(detail, htmlDt, 'htmlFc')  }},
