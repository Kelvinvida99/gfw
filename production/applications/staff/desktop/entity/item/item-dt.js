...
const {organizeRow} = require('./item-dt-handler')
const {tableDetail} = require('./item-dt-handler')
...
function HTMLselect(){ 
      ...
      dtHandler.HTMLselect('item-dt', htmlDt, organizeRow, tableDetail)
...
const obj = {
      ...
      tableOptions:   { start: (detail)=>{  itemMenu.start(detail, htmlDt, 'htmlFc')  }},
      trMenu:         { start: (detail)=>{  itemMenu.start(detail, htmlDt, 'htmlFc')  }},
