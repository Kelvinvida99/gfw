...
const {organizeRow} = require('./investordeposit-dt-handler')
const {tableDetail} = require('./investordeposit-dt-handler')
...
function HTMLselect(){ 
      ...
      dtHandler.HTMLselect('investordeposit-dt', htmlDt, organizeRow, tableDetail)
...
const obj = {
      ...
      tableOptions:   { start: (detail)=>{  investordepositMenu.start(detail, htmlDt, 'htmlFc')  }},
      trMenu:         { start: (detail)=>{  investordepositMenu.start(detail, htmlDt, 'htmlFc')  }},
