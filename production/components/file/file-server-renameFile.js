...
export const start = (detail, scrim_file_rename) => {  
  ...
  if((typeof(detail.ev.key) != "undefined" && detail.ev.key != "Enter")){
    ...
    fileDialog.classList.add("dialog-hide")
    scrim_file_rename.classList.add("scrim-hide")    
    
    remove(()=>{

      fileDialog.classList.remove('dialog-hide');
      fileDialog.classList.remove('dialog-show');
      scrim_file_rename.classList.remove("scrim-hide")  
      scrim_file_rename.classList.remove("scrim-show")  
  ...
  export function openRenameDialog(detail, scrim_file_rename){
    ...
    // const scrimFile = document.querySelector("#scrim_dialog_file");
    // scrimFile.classList.add("scrim-show");  

    // console.log("FILEEEEEEEEEEE!!",scrimFile);
    //BACK BUTTON COTROL
    backControl.hashAdd({ toShow:`hideRenameDialog` })


    
    fileDialog.classList.add("dialog-show");    
    scrim_file_rename.classList.add("scrim-show");    
  ...
  export function hideRenameDialog(detail, scrim_file_rename){ //console.log('dialog hide>')
    
    const dialog = document.querySelector("#file-dialog");
    
    dialog.classList.add('dialog-hide');
    scrim_file_rename.classList.add("scrim-hide");    
    backControl.hashSub({ toHide:`hideRenameDialog` })
    remove(()=>{
