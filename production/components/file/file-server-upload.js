...
export function triggerFileUpload(fulcontId){
...
export const sendFile = (detail, fileNames) => {  //console.log('UPLOADING FILE!!!!!!!!')
  ...
  export function openNewFolderDialog(detail, scrim_file_newFolder){
    ...
    dialog.querySelector("input").select(); 
        ...
        //BACK BUTTON COTROL
        backControl.hashAdd({ toShow:`hideNewFolder` })
  ...
  export function hideNewFolder(detail, scrim_file_newFolder){ //console.log('dialog hide>')
    ...
    backControl.hashSub({ toHide:`hideNewFolder` })
