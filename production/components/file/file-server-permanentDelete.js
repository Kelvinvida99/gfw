...
export const start = (detail) => {  //console.log("FILES SENT TO DELETE", detail.inf ); 
    ...
    document.querySelector('#'+detail.entity+"-fullcont").querySelectorAll('.file-deletedFiles .cont-checked').forEach(function(fileContainer) { 
