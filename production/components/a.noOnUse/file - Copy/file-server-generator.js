...
export function printFile(obj){  //console.log('printingFile####>', obj) 
  /* OBJECT AS PARAMETER
  ...
  */
  ...
  if(fileHmtl != ""){
    ...
    fileHmtl =  `<div class="cont-empty cont-empty-upload" data-detail='{"click": [ {"dest":"ripple"}, {"dest":"file", "act":"triggerFileUpload", "formId":"${obj.formId}"} ] }'>
