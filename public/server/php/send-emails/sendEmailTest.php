...
///////////TEST
$_POST["email"]                      = "cabrera.yeison@gmail.com";
$_POST["name"] = "Yeison Pena";//C:/xampp/htdocs/beeStock/public/server/storage/beestock/entities/sale/sent-invoice/f-invoice_id-8871472.pd
$_POST["pathpdf"] = "/beeStock/public/server/storage/beestock/entities/sale/sent-invoice/f-invoice_id-8871472.pdf";
$_POST["code"] = "INV-TEST-".rand(0, 1000);
$_POST["type"] = "sendinvoice";
...
switch ($_POST["type"]) {
    ...
    case 'sendinvoice':
        ...
        $emailObj->removeAttachement = false;
        $emailObj->files             = [];
        $path_full                   = "C:/xampp/htdocs". parse_url($_POST["pathpdf"])['path'];
