...
//$result = executeDeleteQuery($con, $sql);
    ...
    ///CHECKING IF THERE IS AN AFTER_UPDATE QUERY
    if(file_exists("../queries/".$entity."AfterDelete.php")){
      require "../queries/".$entity."AfterDelete.php";
  ...
  $allQueiresArray = array_merge($sql, $afterDeleteEntityQuery );
